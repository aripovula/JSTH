...
public class UserController {
	...
	public String readsource(Model model) {
		...
		// During testing phase I used this method to get source code in my computer.
		// Then in production version I saved source code generated by this method to a file and
		// in prod. mode app is rendering source code from that saved file.
		//String  allCodeInJsonFormat = sortEngine.getSourceCodeText();
		
		String  allCodeInJsonFormat = sortEngine.getSourceCodeFromFile("/static/source/sourcecode.txt");	
		model.addAttribute("allCodeInJsonFormat", allCodeInJsonFormat);
		// myLogger.info("===========>>>>>>>>>>> in  All code = " + allCodeInJsonFormat);
		String  pom = sortEngine.getSourceCodeFromFile("/static/source/pom.txt");	
	...
	public String formCustomLoad(Model model, Principal principal) {
		...
		// these two are used for displaying checkboxes in multiple columns
